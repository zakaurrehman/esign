  ...
  if (mode === 'select') {
    return (
      <div>
        ...
        <div className="flex flex-row gap-4 w-full max-w-5xl mx-auto">
          <Card className="flex-1 min-w-[180px] max-w-[240px] cursor-pointer hover:shadow-2xl transition-all bg-white rounded-xl border border-slate-100 flex flex-col items-center justify-center p-6" onClick={() => setMode('upload')}>
            <CardContent className="flex flex-col items-center justify-center">
              <div className="bg-gradient-to-br from-violet-100 to-purple-100 w-14 h-14 rounded-xl flex items-center justify-center mb-3">
                <svg className="h-8 w-8 text-violet-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
              </div>
              <h3 className="text-base font-bold text-[#22223b] font-sans">Upload PDF</h3>
              <p className="mt-1 text-xs text-[#2563eb] font-sans text-center">
                Upload an existing PDF document for signing
              </p>
            </CardContent>
          </Card>

          <Card className="flex-1 min-w-[180px] max-w-[240px] cursor-pointer hover:shadow-2xl transition-all bg-white rounded-xl border border-slate-100 flex flex-col items-center justify-center p-6" onClick={() => setMode('edit-pdf')}>
            <CardContent className="flex flex-col items-center justify-center">
              <div className="bg-gradient-to-br from-indigo-100 to-blue-100 w-14 h-14 rounded-xl flex items-center justify-center mb-3">
                <svg className="h-8 w-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                </svg>
              </div>
              <h3 className="text-base font-bold text-[#22223b] font-sans">Annotate PDF</h3>
              <p className="mt-1 text-xs text-[#2563eb] font-sans text-center">
          ...
          <Card className="flex-1 min-w-[180px] max-w-[240px] cursor-pointer hover:shadow-2xl transition-all bg-white rounded-xl border border-slate-100 flex flex-col items-center justify-center p-6" onClick={loadTemplate}>
            <CardContent className="flex flex-col items-center justify-center">
              <div className="bg-gradient-to-br from-emerald-100 to-teal-100 w-14 h-14 rounded-xl flex items-center justify-center mb-3">
                <svg className="h-8 w-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <h3 className="text-base font-bold text-[#22223b] font-sans">Use Template</h3>
              <p className="mt-1 text-xs text-[#2563eb] font-sans text-center">
