...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      {/* Sidebar */}
      <aside className="min-h-screen h-screen fixed inset-0 left-0 bg-gradient-to-b from-indigo-700 via-blue-600 to-blue-500 text-white flex flex-col py-6 px-0 shadow-2xl z-30 select-none" style={{ width: '260px' }}>
